...
const EVENT_TYPE_KEYS = ['BATTLE_END','BATTLE_START','BATTLE_OVERRIDE','NATION_CREATED','NATION_DELETED','SQUAD_CREATED','SQUAD_DELETED','SQUAD_DESTROYED','VESSEL_CREATED','VESSEL_DELETED','TURN_ADVANCE','INFO']
